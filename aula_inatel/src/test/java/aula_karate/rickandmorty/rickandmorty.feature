...
Scenario: Verificar o retorno com sucesso da API Ethan com dados inválidos de requisição
    ...
    Then status 404
@TestThree
Scenario: Verificar o retorno com sucesso da API Ethan com dados válidos de requisição e garantir que o retorno tem o JSON esperado para o personagem 115(name e species)
    Given url url_base
    And path 'character/115'
    When method get
    Then status 200
...
@TestFour
Scenario: Verificar o retorno com sucesso da API Ethan com dados válidos de requisição e garantir que o retorno tem o JSON esperado para o personagem 491 e 589(name e species)
    Given url url_base
...
@TestFive
Scenario: Verificar o retorno com sucesso da API Ethan com dados válidos de requisição e garantir que o retorno tem o JSON esperado quando filtrar os personagens pela espécie = Human e o primeiro personagem ser o Rick Sanchez(name e species)
    Given url url_base
...
@TestSex
Scenario: Verificar o retorno com sucesso da API Ethan com dados inválidos de requisição na hora de filtrar a localização
    Given url url_base
...
@TestSeven
Scenario: Verificar o retorno com sucesso da API Ethan com dados válidos e garantir que o retorno tem o JSON esperado para a localização do personagem Rick Sanchez(name e dimension)
    Given url url_base
